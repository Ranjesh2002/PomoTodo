                  ...
                  <div className="buttons flex h-full">
                    ...
                    {!item.isCompleted && (
                      <button
                        ...
                        className="bg-green-500 hover:bg-green-600 p-3 py-1 text-white rounded-md mx-1 text-sm font-bold"
                        aria-label={`Start Pomodoro for "${item.todo}"`}
                      >
                        <FaPlay />
                      </button>
                    )}
...
// Prop validation for Todo component
Todo.propTypes = {
